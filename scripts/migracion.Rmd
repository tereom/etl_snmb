...
copiaRenombra <- function(dir_j_archivo, dir_local, id_db, nombre){
...
```{r}
# Importando el catálogo de municipio, ya que algunos registros contienen el municipio numéricamente
...
```
### Escribiendo tablas en las bases de datos SQLite y PostgreSQL
...
###Copiando las bases del cliente nuevo a una carpeta para fusionarlas con la base anterior

```{r}
dir_j = "/Volumes/sacmod"

#bases del nuevo cliente:
bases_web2py_rutas <- list.files(path = dir_j,
recursive = TRUE, full.names = TRUE, pattern ="storage\\.sqlite$")

#seleccionando bases

bases_web2py_rutas_2<-c(
  "/Volumes/sacmod/data_10_03_2015/SARMOD_CONANP_ENTREGA_02032015/SARMOD_CONANP_ENTREGA_TEHCUI_02032015/ENTREGA_1/CLIENTE_SNMB_1/CLIENTE_SNMB_1/applications/init/databases/storage.sqlite",
  "/Volumes/sacmod/data_10_03_2015/SARMOD_OSC_ENTREGA_02032015/SARMOD_FMCN_ENTREGA_ESPACIOAUTONOMO_02032015/ENTREGA_1/CLIENTE_SNMB_#1/CLIENTE_SNMB_1/applications/init/databases/storage.sqlite",
  "/Volumes/sacmod/sarmod_05052015/cliente_snmb/applications/init/databases/storage.sqlite",
  "/Volumes/sacmod/SARMOD_CONANP_ENTREGA_1_26032015/SARMOD_CONANP_DONMARTIN_24032015/ENTREGA_1/CLIENTE_SNMB_1 conglomerado/cliente_snmb/applications/init/databases/storage.sqlite",
  "/Volumes/sacmod/SARMOD_CONANP_ENTREGA_1_26032015/SARMOD_CONANP_RBMM_16032015/ENTREGA_1/CLIENTE_SNMB_1 conglomerado/Cliente_snmb/applications/init/databases/storage.sqlite",
  "/Volumes/sacmod/SARMOD_CONANP_ENTREGA_1_26032015/SARMOD_CONANP_SSPM_10032015/ENTREGA_1/CLIENTE_SNMB_1 conglomerado/Cliente_snmb/applications/init/databases/storage.sqlite",
  )
...
snmb_id <- sapply(1:length(bases_web2py_rutas_2), function(i) 
  copiaRenombra(bases_web2py_rutas_2[i], 
    "../datos/bases_web2py_snmb", i, "storage.sqlite"))
```
