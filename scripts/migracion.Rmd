...
```{r}
# Tabla para localizar "sitio_muestra_id" de una cámara, por medio de "conglomerate_id"
# y "location_camera", 
...
camara_sitio$resolution[grep("11520", camara_sitio$resolution)] <- "12MP"
...
Archivo_camara <-  inner_join(archivos_camara, trap_camera_sub, 
  ...
  select(id, camara_id, archivo, archivo_nombre_original, presencia, 
